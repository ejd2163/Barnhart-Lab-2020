...
T = numpy.arange(0,5,t) #(0,5,t) for flashes; (0,31,t) for gratings
...
parent_dir = 'C:/Users/vymak_i7/Desktop/New_ER/Screen/Mi1/2s_flashes/'
parent_m_dir = parent_dir + '/measurements/'
parent_path = path('C:/Users/vymak_i7/Desktop/New_ER/Screen/Mi1/2s_flashes/')
...
for br in brain_regions[:]:
    O_DFF=[]
    for directory,p,row in zip(dir_list[:12],path_list[:12],rows[:12]):
        OUT_DFF=[]
        print(directory)
        ...
        #out.save(directory+'/'+br+'_ER210_labels.tif')
        print(labels[1])
        ...
        #while n==1:
            ...
            pylab.savefig(plot_dir+'/'+br+'-ROI-'+str(n)+'-ER210.png',dpi=300,bbox_inches = 'tight')
            #pylab.show()
            pylab.close()
            n=n+1
            
        datafile.write_data_file([header_out]+OUT_DFF,m_dir+'average_responses-'+br+'-ER210.csv')
    ...
    datafile.write_data_file([header_out]+O_DFF,parent_m_dir+'average_responses-'+br+'-ER210.csv')
