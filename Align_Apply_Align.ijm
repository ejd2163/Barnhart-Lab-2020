/*   
 *   This macro will calculate the alignment of any 1 of 2
 *   channels of a selected raw image, apply these 
 *   calculations to align the 2nd channel, and save the 
 *   average projection of the entire aligned image and
 *   the aligned image sequences of both channels.
 *  
 */ 
...
//(Section 2) ALIGN FIRST CHANNEL W/ STRONGEST SIGNAL (for TurboReg instructions, visit this website: http://bigwww.epfl.ch/thevenaz/turboreg/)
	...
	setBatchMode(false); //exit batch mode, shows most recent active window ("A_Aligned")
...
//(Section 3) ALIGN SECOND CHANNEL W/ ALIGNMENT CALCULATIONS OF FIRST CHANNEL
	...
	setBatchMode(false); //exit batch mode, shows most recent active window ("B_Aligned")
